...
void handleFileUpload(){
  ...
  if(upload.status == UPLOAD_FILE_START){
    ...
    DBG_OUTPUT_PORT.println((char *)upload.filename.c_str());
    DBG_OUTPUT_PORT.println(host);
    DBG_OUTPUT_PORT.println(WiFi.localIP());
    balance += 1;
    DBG_OUTPUT_PORT.println(balance);
    DBG_OUTPUT_PORT.println("The previous hash");
    DBG_OUTPUT_PORT.println("The calculated new hash");
  }
}
